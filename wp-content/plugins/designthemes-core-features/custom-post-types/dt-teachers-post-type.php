...
if (! class_exists ( 'DTTeachersPostType' )) {
	class DTTeachersPostType {
		...
		function dt_add_teacher_meta_box() {
			add_meta_box ( "dt-teacher-default-metabox", __ ( 'Default Options', 'dt_themes' ), array (
					$this,
					'dt_default_metabox' 
		...
		function save_post_meta($post_id) {
			...
			if(isset($_POST['layout'])) :
				...
				$settings ['course'] = isset ( $_POST ['_course'] ) ? stripslashes ( $_POST ['_course'] ) : "";
				...
				$settings ['social-icon'] = $_POST ['social_icon'];
				$settings ['social-link'] = array_filter($_POST ['social_link']);
