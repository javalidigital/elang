          ...
          jQuery(document).ready(function($) {
            ...
            <table border="0" cellpadding="5" id="rsmaps">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <textarea name="address" id="address" rows="3" cols="71" type='textarea' onblur="updateMap(pluginurl)">Yeronga QLD 4104, Australia</textarea><br>
                    ...
                    <td rowspan="15" valign="top" valign="top" width="600px">
                        <div id="responsive_map" class="responsive-map" style="height:500px;width:600px;"></div>
                        <!-- Update map button -->
                        <a href="javascript: updateMap(pluginurl);" class="rsbutton"><?php echo __('REFRESH THE MAP') ?></a>
                        <a href="https://www.google.com/maps" class="rsbutton" target="_blank"><?php echo __('GOOGLE MAPS') ?></a>
                        <a href="http://yava.ro/mapgenerator" class="rsbutton" target="_blank"><?php echo __('LATITUDE / LONGITUDE FINDER TOOL') ?> </a>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <textarea name="pdescription" id="pdescription" rows="3" cols="71" type='textarea' onblur="updateMap(pluginurl)"><img src='<?php echo plugins_url(); ?>/responsive-maps-plugin/includes/img/company.png'> {br} Yeronga QLD 4104, Australia {br} Phone:  0040 752 235 756</textarea><br>
                ...
                <tr>
                    ...
                    <td valign="bottom">
                        <label><input name="color" type="radio" value="black" onclick="updateMap(pluginurl)" /> <img src="<?php echo plugins_url(); ?>/responsive-maps-plugin/includes/icons/black.png"> </label>
                        <label><input name="color" type="radio" value="blue" onclick="updateMap(pluginurl)" /> <img src="<?php echo plugins_url(); ?>/responsive-maps-plugin/includes/icons/blue.png"> </label>
                        <label><input name="color" type="radio" value="gray" onclick="updateMap(pluginurl)" /> <img src="<?php echo plugins_url(); ?>/responsive-maps-plugin/includes/icons/gray.png"> </label>
                        <label><input name="color" type="radio" value="green" onclick="updateMap(pluginurl)" checked/> <img src="<?php echo plugins_url(); ?>/responsive-maps-plugin/includes/icons/green.png"> </label>
                        <label><input name="color" type="radio" value="magenta" onclick="updateMap(pluginurl)" /> <img src="<?php echo plugins_url(); ?>/responsive-maps-plugin/includes/icons/magenta.png"> </label>
                        <label><input name="color" type="radio" value="orange" onclick="updateMap(pluginurl)" /> <img src="<?php echo plugins_url(); ?>/responsive-maps-plugin/includes/icons/orange.png"> </label>
                        <label><input name="color" type="radio" value="purple" onclick="updateMap(pluginurl)" /> <img src="<?php echo plugins_url(); ?>/responsive-maps-plugin/includes/icons/purple.png"> </label>
                        <label><input name="color" type="radio" value="red" onclick="updateMap(pluginurl)" /> <img src="<?php echo plugins_url(); ?>/responsive-maps-plugin/includes/icons/red.png"> </label>
                        <label><input name="color" type="radio" value="white" onclick="updateMap(pluginurl)" /> <img src="<?php echo plugins_url(); ?>/responsive-maps-plugin/includes/icons/white.png"> </label>
                        <label><input name="color" type="radio" value="yellow" onclick="updateMap(pluginurl)" /> <img src="<?php echo plugins_url(); ?>/responsive-maps-plugin/includes/icons/yellow.png"> </label>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <textarea name="iconurl" id="iconurl" rows="2" cols="68" type='textarea' onblur="">http://yava.ro/icons/car.png</textarea><br>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Color picker -->
                        <input type="text" id="mapcolor" name="mapcolor" value="#2bb49f" data-text="select the color..."/>
                        <span class="info" id="colorinfo"><?php echo __('Choose from 40 custom styles or a specific color.') ?></span>
                        <input type="hidden" name ="newcolor" id="newcolor" value="#2bb49f"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" size="5" name="width" id="width" value="100" onblur="updateMap(pluginurl)"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" size="5" name="height" id="height" value="500" onblur="updateMap(pluginurl)"/>
