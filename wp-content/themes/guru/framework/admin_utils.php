...
function dt_theme_default_option() {
	$general = array (
			...
			"top-bar-left-content" => 'Create you own custom course. <a href="#" title="Learn How?">Learn How?</a>',
			"copyright-text" => '&copy; 2014 - Guru - by <a href="http://themeforest.net/user/designthemes" title="">Design Themes</a>'
	);
