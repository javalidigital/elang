	...
	function page_settings($args){
        ...
        <div class="j-pagetemplate-container">
            	...
            	<div id="tpl-common-settings">
                    ...
                    <div id="page-commom-sidebar" class="custom-box">
                    	<div class="column one-sixth">
                        ...
                        <div class="column five-sixth last">
                            ...
                            <p class="note"> <?php _e('Yes! to hide "Every Where Sidear" on this page.','iamd_text_domain');?> </p>
                        </div>
               ...
               <div id="tpl-gallery">
                  ...
                  <div class="custom-box">
                      <div class="column one-sixth">
                          <label><?php _e('Type of Posts Design','iamd_text_domain');?></label>
                      </div>
                      <div class="column five-sixth last">
                      	  <?php $post_design = array( 'default' => __('Default', 'iamd_text_domain'),
                          ...
                          <select name="mytheme-gallery-post-design-type">
                          ...
                          <p class="note"> <?php _e("Your gallery posts show with choosen shape.",'iamd_text_domain');?> </p>
                      </div>
