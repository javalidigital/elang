    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel">
			<?php $sub_menus = array(
						...
						array("title"=>__("Layouts",'iamd_text_domain'), "link"=>"#appearance-layout"),
						array("title"=>__("Colors",'iamd_text_domain'), "link"=>"#appearance-styling"));
        ...
        <div id="appearance-styling" class="tab-content">
        	<div class="bpanel-box">
                <div class="box-title"><h3><?php _e('Disable Styling Settings','iamd_text_domain');?></h3></div>
                <div class="box-content">
                    <div class="bpanel-option-set">
                    	<h6><?php _e('Disable Styling Settings','iamd_text_domain');?></h6>
                        <?php dt_theme_switch("",'appearance','disable-styling-settings');?>
                        <p class="note"> <?php _e('Enable or Disable the styling settings','iamd_text_domain');?>  </p>
                    </div>
				</div>
            </div>
        	...
        	<div class="bpanel-box">
                <div class="box-title"><h3><?php _e('Top Bar Styling','iamd_text_domain');?></h3></div>
                <div class="box-content">
					<div class="column one-half">
                    <?php $label = 		__("Background Color for Top Bar",'iamd_text_domain');
                          ...
                          $tooltip = 	__("Pick a custom background color for top bar e.g. #551256",'iamd_text_domain'); ?>
                          <h6><?php echo $label;?></h6>
                          <?php dt_theme_admin_color_picker("",$name,$value,'');?>  
                          <p class="note"><?php echo $tooltip;?></p>                  
                    </div>
                    ...
                    <div class="column one-half last">
                    <?php $label = 		__("Text & Link Color for Top Bar",'iamd_text_domain');
                          ...
                          $tooltip = 	__("Pick a custom color for top bar text & links e.g. #564912",'iamd_text_domain'); ?>
                          <h6><?php echo $label;?></h6>
                          <?php dt_theme_admin_color_picker("",$name,$value,'');?>   
                          <p class="note"><?php echo $tooltip;?></p>                 
                    </div>
        	...
        	<div class="bpanel-box">
                <div class="box-title"><h3><?php _e('Header Styling','iamd_text_domain');?></h3></div>
                <div class="box-content">
					<div class="column one-half">
                    <?php $label = 		__("Background Color for Header",'iamd_text_domain');
                          ...
                          $tooltip = 	__("Pick a custom background color for header e.g. #551256",'iamd_text_domain'); ?>
                          <h6><?php echo $label;?></h6>
                          <?php dt_theme_admin_color_picker("",$name,$value,'');?>  
                          <p class="note"><?php echo $tooltip;?></p>                  
                    </div>
                    ...
                    <div class="column one-half last">
                    <?php $label = 		__("Active Menu BG Color",'iamd_text_domain');
                          ...
                          $tooltip = 	__("Pick a custom color for header active menu background e.g. #564912",'iamd_text_domain'); ?>
                          <h6><?php echo $label;?></h6>
                          <?php dt_theme_admin_color_picker("",$name,$value,'');?>   
                          <p class="note"><?php echo $tooltip;?></p>                 
                    </div>
        	...
        	<div class="bpanel-box">
                <div class="box-title"><h3><?php _e('Breadcrumb Styling','iamd_text_domain');?></h3></div>
                <div class="box-content">
					<div class="column one-half">
                    <?php $label = 		__("Background Color for Breadcrumb",'iamd_text_domain');
                          ...
                          $tooltip = 	__("Pick a custom background color for breadcrumb e.g. #551256",'iamd_text_domain'); ?>
                          <h6><?php echo $label;?></h6>
                          <?php dt_theme_admin_color_picker("",$name,$value,'');?>  
                          <p class="note"><?php echo $tooltip;?></p>                  
                    </div>
                    ...
                    <div class="column one-half last">
                    <?php $label = 		__("Breadcrumb's Text Color",'iamd_text_domain');
                          ...
                          $tooltip = 	__("Pick a custom color for breadcrumb text & links e.g. #564912",'iamd_text_domain'); ?>
                          <h6><?php echo $label;?></h6>
                          <?php dt_theme_admin_color_picker("",$name,$value,'');?>   
                          <p class="note"><?php echo $tooltip;?></p>                 
                    </div>
			...
			<!-- start body styling -->
        	<div class="bpanel-box">
                <div class="box-title"><h3><?php _e('Body Styling','iamd_text_domain');?></h3></div>
                <div class="box-content">
					<div class="column one-half">
                    <?php $label = 		__("Background Color for Body",'iamd_text_domain');
                          ...
                          $tooltip = 	__("Pick a custom background color for body e.g. #551256",'iamd_text_domain'); ?>
                          <h6><?php echo $label;?></h6>
                          <?php dt_theme_admin_color_picker("",$name,$value,'');?>  
                          <p class="note"><?php echo $tooltip;?></p>                  
                    </div>
        	...
        	<div class="bpanel-box">
                <div class="box-title"><h3><?php _e('Footer Styling','iamd_text_domain');?></h3></div>
                <div class="box-content">
					<div class="column one-half">
                    <?php $label = 		__("Background Color for Footer",'iamd_text_domain');
                          ...
                          $tooltip = 	__("Pick a custom background color for footer e.g. #551256",'iamd_text_domain'); ?>
                          <h6><?php echo $label;?></h6>
                          <?php dt_theme_admin_color_picker("",$name,$value,'');?>  
                          <p class="note"><?php echo $tooltip;?></p>                  
                    </div>
                    ...
                    <div class="column one-half last">
                    <?php $label = 		__("Footer Text Color",'iamd_text_domain');
                          ...
                          $tooltip = 	__("Pick a custom color for footer text & links e.g. #564912",'iamd_text_domain'); ?>
                          <h6><?php echo $label;?></h6>
                          <?php dt_theme_admin_color_picker("",$name,$value,'');?>   
                          <p class="note"><?php echo $tooltip;?></p>                 
                    </div>
        	...
        	<div class="bpanel-box">
                <div class="box-title"><h3><?php _e('Sub Footer Styling','iamd_text_domain');?></h3></div>
                <div class="box-content">
					<div class="column one-half">
                    <?php $label = 		__("Background Color for Sub-Footer",'iamd_text_domain');
                          ...
                          $tooltip = 	__("Pick a custom background color for sub-footer e.g. #551256",'iamd_text_domain'); ?>
                          <h6><?php echo $label;?></h6>
                          <?php dt_theme_admin_color_picker("",$name,$value,'');?>  
                          <p class="note"><?php echo $tooltip;?></p>                  
                    </div>
                    ...
                    <div class="column one-half last">
                    <?php $label = 		__("Sub-Footer Text Color",'iamd_text_domain');
                          ...
                          $tooltip = 	__("Pick a custom color for sub-footer text & links e.g. #564912",'iamd_text_domain'); ?>
                          <h6><?php echo $label;?></h6>
                          <?php dt_theme_admin_color_picker("",$name,$value,'');?>   
                          <p class="note"><?php echo $tooltip;?></p>                 
                    </div>
