...
<div id="general" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        ...
        <div id="my-general" class="tab-content">
            ...
            <div class="bpanel-box">
                    ...
                    <div class="box-content">
                      ...
                      <h6><?php _e('Globally Disable Comments on Teachers','iamd_text_domain');?></h6>
                      <div class="column one-fifth">
                        	<?php $checked = ( "true" ==  dt_theme_option('general','disable-teacher-comment') ) ? ' checked="checked"' : ''; ?>
                            <?php $switchclass = ( "true" ==  dt_theme_option('general','disable-teacher-comment') ) ? 'checkbox-switch-on' :'checkbox-switch-off'; ?>
                        ...
                        <div class="column four-fifth last">
                        	<p class="note"><?php _e('Enable/ Disable comments on teacher pages.','iamd_text_domain');?> </p>
                        </div>
                        <div class="hr"></div>
        ...
        <div id="my-top" class="tab-content">
            ...
            <div class="bpanel-box">
				<div class="box-title"><h3><?php _e('Newsletter Form List Name','iamd_text_domain');?></h3></div>
                <div class="box-content"><?php
                    ...
                    <option value=""><?php _e('Choose List Name', 'iamd_text_domain'); ?></option><?php
						if(!empty($lists)):
						  foreach ($lists['data'] as $key => $value):
                            $id = $value['id'];
                            $name = $value['name'];
                            $selected = selected(dt_theme_option('general','newsletter-listid'), $id, false);
                            echo "<option $selected value='$id'>$name</option>";
                          endforeach;
						endif; ?></select>
					<p class="note"><?php _e('Set mailchimp api key before selecting the list.','iamd_text_domain');?></p>
                </div>
			</div><!-- .bpanel-box end-->
		</div>
