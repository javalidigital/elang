                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
                        ...
                        foreach ( $custom_post_types as $post_type_key => $post_type_name ){
							$switchclass = ( $post_type_key ==  dt_theme_option('pagebuilder', $post_type_key) ) ? 'checkbox-switch-on' :'checkbox-switch-off';
                            ...
                            <div class="column two-third last">
                                 ...
                                 <?php checked(dt_theme_option('pagebuilder',$post_type_key),$post_type_key);?>/>
                            </div>
                    ...
                    <div class="bpanel-option-set">
						...
						?>
                         <h6><?php _e('Keep page builder active in above selected post types','dt_themes'); ?></h6>
