        ...
        <div id="bpanel-wrapper">
           	...
           	<div id="bpanel">
                        ...
                        <?php $status = dt_theme_is_plugin_active('all-in-one-seo-pack/all_in_one_seo_pack.php')|| dt_theme_is_plugin_active('wordpress-seo/wp-seo.php');
							  ...
							  if(!$status):
								$tabs = array(
									...
									array('id'=>'sensei', 'name'=>__('Sensei','iamd_text_domain')),
                    ...
                    <form id="mytheme_options_form" name="mytheme_options_form" method="post" action="options.php">
                        ...
                        <div class="top-links">
                            <?php  $import_disable = (dt_theme_option('general','disable-import') == "on") ? "import-disabled" :""; ?>                        
	                        <a class="mytheme-import-button bpanel-button blue-btn <?php echo $import_disable;?>"><?php _e('Import Dummy Data','iamd_text_domain');?></a>
                        </div>
                        ...
                        <?php require_once(get_template_directory().'/framework/theme_options/sensei.php');?>
