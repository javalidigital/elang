...
function dt_theme_enqueue_styles() {
	...
	if($theme = dt_theme_option('appearance','skin'))
		...
		wp_enqueue_style("skin", IAMD_BASE_URL."skins/dark-blue/style.css");
	...
	wp_enqueue_style('menumenu', IAMD_BASE_URL.'css/meanmenu.css');
	...
	if(dt_theme_is_plugin_active('woothemes-sensei/woothemes-sensei.php'))
		wp_enqueue_style('stylesensei', IAMD_BASE_URL.'sensei/css/style.css');
