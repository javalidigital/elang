...
function dt_woocommerce_image_dimensions() {
	$catalog = array('width' => '520', 'height'	=> '535', 'crop' => 1);
...
function dt_woocommerce_template_loop_product_thumbnail() {
	...
	$image = !empty( $image ) ? $image : "<img src='http://placehold.it/520x535' alt='product-thumb' />";
...
function dt_woocommerce_before_shop_loop_item_title() {
	$out = "";
	$out .= "<div class='product-title'><a href='".get_permalink()."'>";
	echo $out;
}
