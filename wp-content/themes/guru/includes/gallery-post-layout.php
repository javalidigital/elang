			...
			<div class="<?php echo $design_type." ".$li_class." ".strtolower(implode(" ", $terms)); ?>">
              <figure class="gallery-thumb <?php echo $design_type; ?>"><?php
                if($design_type != 'default no-space'): ?>
				    <img class="item-mask" alt="mask" width="460" height="460" src="<?php echo get_template_directory_uri(); ?>/skins/<?php echo dt_theme_option('appearance','skin'); ?>/images/<?php echo $design_type; ?>.png" /><?php
				endif; 
