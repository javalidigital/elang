              ...
              <section class="<?php echo $page_layout; ?>" id="primary">
                  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                      <ul class="side-nav"><?php
                        ...
                        foreach( $ids as $id ) {
                            ...
                            $permalink = get_permalink( $id );
                                ...
                                $class = !empty($current_meta['menu-icon-class']) ? $current_meta['menu-icon-class'] : "icon-bullseye";
                      ...
                      <div class="with-side-nav">
                        <div class="hr-title"><h2><?php the_title(); ?></h2><div class="title-sep"><span></span></div></div><?php
                          //PAGE TOP CODE...
